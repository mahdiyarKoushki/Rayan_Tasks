...
import { Task, Habit, Goal, AppSettings } from './types';
...
/**
 * Updates partial collections (tasks, habits, goals, settings) and commits to disk.
 */
export function updateDatabase(updates: Partial<DatabaseSchema>): DatabaseSchema {
...
/**
 * Resets the database to default seed state.
 */
